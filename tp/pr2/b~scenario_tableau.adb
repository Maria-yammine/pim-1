pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~scenario_tableau.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~scenario_tableau.adb");
...
package body ada_main is
   ...
   E115 : Short_Integer; pragma Import (Ada, E115, "ensembles_tableau_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_scenario_tableau");
