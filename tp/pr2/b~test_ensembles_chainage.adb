pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_ensembles_chainage.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_ensembles_chainage.adb");
...
package body ada_main is
   ...
   E115 : Short_Integer; pragma Import (Ada, E115, "ensembles_chainage_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_ensembles_chainage");
...
--  BEGIN Object file/option list
   --   ./ensembles_chainage.o
   --   ./test_ensembles_chainage.o
   --   -L./
