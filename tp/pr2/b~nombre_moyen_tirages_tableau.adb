pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~nombre_moyen_tirages_tableau.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~nombre_moyen_tirages_tableau.adb");
...
package body ada_main is
   ...
   E116 : Short_Integer; pragma Import (Ada, E116, "alea_E");
   E128 : Short_Integer; pragma Import (Ada, E128, "ensembles_tableau_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_nombre_moyen_tirages_tableau");
...
--  BEGIN Object file/option list
   --   ./alea.o
   --   ./ensembles_tableau.o
   --   ./nombre_moyen_tirages_tableau.o
   --   -L./
