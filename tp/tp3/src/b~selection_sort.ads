...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_selection_sort" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a024be0f#;
   pragma Export (C, u00001, "selection_sortB");
   ...
   u00114 : constant Version_32 := 16#935938d8#;
